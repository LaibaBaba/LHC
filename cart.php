...
$row = mysqli_fetch_assoc($result)
        ?>
            ...
            <tr>
           <td><img src="admin/<?php echo $row['thumb']?> " alt="" class="w-25 "></td>
           ...
           <td><?php echo $row['price'] * $value['quantity'] ?> </td>
            <td><a class="text-dark btn btn-danger"href='deleteCart.php?id=<?php echo $key; ?>'>Remove</a></td>
            </tr>
...
<div class="card-body">
Total Amount: PKR <?php echo $total; ?>/-
</div>
</div>
